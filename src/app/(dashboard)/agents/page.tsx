  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-muted-foreground">
        Tu agente IA con tu propia API key — configuralo, probalo en el
        laboratorio y después deja que responda clientes en la bandeja de entrada.
      </p>
        ...
        >
          <TabsList>
            <TabsTrigger value="playground">
              <Sparkles className="mr-1.5 h-4 w-4" /> Laboratorio
            </TabsTrigger>
